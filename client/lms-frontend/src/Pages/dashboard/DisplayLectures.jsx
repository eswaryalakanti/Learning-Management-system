...
import { deletelecture, getallthelecture } from "../../redux/slice/lectureSlice";
import { getalllectures } from "../../redux/slice/courseslice";
...
function DisplayLectures() {
    ...
    useEffect(() => {
        ...
        dispatch(getallthelecture(state._id));
    }, [])
