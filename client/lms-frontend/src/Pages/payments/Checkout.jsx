...
import { getrazorpayid, purchasecourses, verifyrazorpaypayment } from "../../redux/slice/razorpay_slice";
...
function Checkout() {
    ...
    async function handleSubscription(e) {
        e.preventDefault();
        const res = await dispatch(verifyrazorpaypayment(paymentDetails));
        console.log("res on checkout",res?.payload?.data?.success, paymentDetails);
    ...
    async function load() {
        ...
        await dispatch(purchasecourses());
    }
